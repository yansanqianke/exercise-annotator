...
const routes = [
  ...
  { path: '/annotate', name: 'Annotate', component: () => import('../views/annotate/Annotate.vue'), meta: { requiresAuth: true, title: '题目标注' } },
  { path: '/documents', name: 'Documents', component: () => import('../views/documents/DocumentList.vue'), meta: { requiresAuth: true, title: '文档解析' } },
